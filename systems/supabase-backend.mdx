...
- A queued message gets 10 tries with a growing pause between them, so the queue rides out a short refusal spell on its own. Past the tenth try the message becomes a dead letter; see [Redrive a dead letter](/handbook/running/redrive-a-dead-letter).
