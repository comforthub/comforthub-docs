...
| Timesheet reminder | everyone except the super admins whose timesheet for the period does not exist or is a draft | the pay period's submit-by day is tomorrow | 9:00 the day before |
...
| Pipeline needs attention | the super admins | at least one pipeline state has something stuck in it; the body lists the states and their counts | 8:40 daily |
