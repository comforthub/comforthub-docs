...
The app has three tabs along the bottom: **Home**, **Phone**, and a magnifying glass that opens the **Search** hub. Home is the day. Phone is the line. Everything else in the app lives behind the magnifying glass.
...
Twenty-two rows in five groups, with **Agent** on its own at the top. The hub is the app's table of contents.
...
**Agent** opens over the whole screen rather than pushing, because it is a conversation you step into and back out of.

**Approvals** shows only for someone who can approve; everyone else sees four rows under **You**.
...
The search box at the bottom of the hub searches across the app at once and groups what it finds: **Contacts**, **Jobs**, **Equipment**, **Tasks**, **Notes**, **Suppliers**, **Messages**, **Voicemail**, **Callbacks** and **Screens**.
...
**Hours** is empty for the owner. It says the owner does not file hours, which is correct: the owner approves them and does not submit them. Technicians see their pay period there instead.
