...
- The supplier's address is on our allowlist or one of our alias domains. Anything else is redirected to the operator with "[TEST → …]" in the subject, and the order is not stamped sent. See [Email safety](/handbook/running/email-safety).
