...
- Within a minute the product shows a **QBO Id**. That number is the QuickBooks item.
...
- **No QBO Id after a few minutes.** The engine could not reach QuickBooks and the job is parked. See [Fix a record that did not sync](/handbook/running/fix-a-record-that-did-not-sync).
