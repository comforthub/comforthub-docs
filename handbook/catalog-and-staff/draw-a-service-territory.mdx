...
- **Supabase Territory Id** stays empty on a territory you create in Zoho until our side first pushes an edit back; then it fills in. Either way the link is kept on our side.
