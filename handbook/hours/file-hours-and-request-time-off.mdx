...
- Signed in as a technician. **Hours** is empty for the owner, and says so: the owner approves hours and does not file them.
...
**Statutory holidays are already filled in.** The app writes 8 hours against each statutory holiday in the period the first time the timesheet is opened, and you cannot edit those days. The engine keeps the eight statutory holidays of the year from ADP's calendar; the two worked holidays are ordinary days.
