...
- The **Schedule** table lists the year's pay periods with period end, submit-by, processing and pay dates; the **Holidays** table lists the year's ten holidays with a statutory yes or no.
- The engine holds the same calendar: every pay period, and the eight statutory holidays. The two worked holidays, marked statutory No, stay in Zoho only; they are normal work days in the app.
...
- The status never changes: the read died on the queue and the monitor has opened a condition in Sentry. See [Act on a Sentry email](/handbook/running/act-on-a-sentry-email), then [Redrive a dead letter](/handbook/running/redrive-a-dead-letter) once the record is fixed.
