...
<Steps>
  <Step title="Read the condition">
    The monitor opens a condition titled **The payroll calendar has insufficient future coverage** when 60 days or fewer remain. It is marked for review while some days remain, and urgent when none remain or no calendar is loaded. Its evidence names the number of days left and the last submit-by date loaded.
  </Step>
