...
- Cancelling an invoiced work order voids its invoice the same way: the engine sets the Zoho invoice to Void, and the rest follows.
- The work order's billing status stays Invoiced after a void. Nothing changes it.
