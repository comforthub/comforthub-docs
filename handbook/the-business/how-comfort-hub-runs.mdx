...
The work order's lines decide this. Every line is billed to the customer, to warranty, or to the subscription. The job is invoiced only for what is billed to the customer, and a job with nothing billed to the customer never makes an invoice. See [How booking works](/handbook/booking/how-booking-works) for the rule.
