...
```mermaid
flowchart LR
  P[Prospect] -->|converted| C[Customer + property]
  C --> W[Work order]
  W --> A[Appointment]
...
- **The office works in Zoho.** Prospects, customers, booking, checklists, timesheet approvals, and anything that needs a record edited by hand.
...
<Columns cols={2}>
  <Card title="New customers" href="/handbook/new-customers/how-a-prospect-becomes-a-customer">From a lead to a customer with all their records.</Card>
