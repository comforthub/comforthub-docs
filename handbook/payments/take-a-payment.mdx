...
- The invoice reads Paid here but no receipt arrives: a step after the payment is failing. It is tried again, and the monitor opens an urgent condition in Sentry once it dies. See [Act on a Sentry email](/handbook/running/act-on-a-sentry-email).
